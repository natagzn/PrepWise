...
object SharedSetListProvider {
    ...
    val sharedSetList = arrayListOf(
        SharedSet(
            ...
            questions = arrayListOf(Question("What is 2+2?", "4")),
            username = "math_guru",
            isLiked = true
        ),
        SharedSet(
            ...
            questions = arrayListOf(Question("Who discovered America?", "Columbus")),
        ...
        SharedSet(
            ...
            questions = arrayListOf(Question("What is the powerhouse of the cell?", "Mitochondria")),
            username = "bio_lover",
            isLiked = true
        ),
        SharedSet(
            ...
            questions = arrayListOf(Question("What is Schrödinger's cat?", "Paradox")),
        ...
        SharedSet(
            ...
            questions = arrayListOf(Question("What is H2O?", "Water")),
