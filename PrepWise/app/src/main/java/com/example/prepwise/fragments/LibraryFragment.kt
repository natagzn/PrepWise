...
class LibraryFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val foldersList = FolderListProvider.folderList
        val setsList = SetListProvider.setList
        val sharedList = SharedSetListProvider.sharedSetList
        val resourcesList = ResourceListProvider.resourceList
